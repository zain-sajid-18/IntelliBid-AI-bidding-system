...
import { Clock, DollarSign, Calendar, Info, Eye, Flame } from "lucide-react";
import { useListingStore, DURATIONS } from "@/store/listingStore";
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs font-bold text-[var(--ink)]/50">
                            Ends: {endTime.toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric', year: 'numeric' })}
                        </p>
                    </div>
